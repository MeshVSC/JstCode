...
export default function CustomPreview({ code, filename, allFiles }: CustomPreviewProps) {
      ...
      <div className="h-full w-full flex items-center justify-center bg-gray-50">
        <div className="text-center text-gray-500">
          <div className="text-4xl mb-2">
            <svg className="w-10 h-10 mx-auto text-gray-400 animate-spin" fill="none" viewBox="0 0 24 24">
  ...
  return (
    <div className="h-full w-full">
      {debugInfo && (
        <div className="bg-blue-100 border border-blue-300 text-blue-800 p-2 text-xs">
          Debug: {debugInfo}
        </div>
      )}
      <iframe
